...
{
    use HasFactory;
    protected $fillable = ['brand', 'model', 'plate_number', 'user_id', 'km', 'cc', 'hp', 'color', 'vehicle_type', 'registration_year', 'registration_month', 'gas_type_id', 'mechanic_id']; //TODO: na to synexiso edo auto me to fillable opos kai sta ypolypa models
